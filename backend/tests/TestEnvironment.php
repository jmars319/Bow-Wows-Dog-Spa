    ...
    public static function boot(): self
    {
        ...
        Config::load([
            ...
            'media' => [
                ...
                'r2_public_bucket' => '',
                'r2_private_bucket' => '',
                'r2_public_base_url' => 'https://cdn.bowwowsdogspa.com',
            ...
            'calendar_sync' => [
                ...
                'google_redirect_uri' => 'http://localhost.test/api/admin/calendar-integrations/google/callback',
                'google_token_key' => base64_encode(str_repeat('k', 32)),
                'google_scopes' => [
